...
/* harmony import */ var _confirm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./confirm */ "./resources/js/confirm.js");
/* harmony import */ var _confirm__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_confirm__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modalForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modalForm */ "./resources/js/modalForm.js");
/* harmony import */ var _modalForm__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modalForm__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _select__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./select */ "./resources/js/select.js");
/* harmony import */ var _select__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_select__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _propuestas__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./propuestas */ "./resources/js/propuestas.js");
/* harmony import */ var _propuestas__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_propuestas__WEBPACK_IMPORTED_MODULE_6__);
...
window.TTConfirm = function () {
  ...
  var handleConfirm = function handleConfirm(e) {
    for (var i = 0; i < confirmsForms.length; i++) {
      confirmsForms[i].addEventListener('submit', function (e) {
        e.preventDefault();
        var formConfirm = e.currentTarget;
        var submitButton = formConfirm.querySelector("button[type='submit']");
        submitButton.disabled = true;
        var confirmTitle = formConfirm.getAttribute('tt-title');
        if (!confirmTitle) confirmTitle = '¿Seguro que desea realizar la acción?';
        var confirmText = formConfirm.getAttribute('tt-text');
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            var actionUrl = formConfirm.action;
            var sendData = new FormData(formConfirm);
            axios.post(actionUrl, sendData).then(function (result) {
  ...
  return {
    init: function init(confirmSelector) {
      var elSuccessFunc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
window.TTModalForm = function () {
  ...
  var title;
  var endHere;
  var handleModalForm = function handleModalForm(e) {
    // let data = {};
    for (var i = 0; i < triggers.length; i++) {
      triggers[i].addEventListener('click', /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(evt) {
          var results, elId, inputs, i, theName;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  evt.preventDefault();
                  results = {};
                  elId = evt.currentTarget.getAttribute(idAttribute);
                  if (!loadData) {
                    _context.next = 6;
                    break;
                  }
                  _context.next = 6;
                  return axios.get(loadData.replace('content', elId)).then(function (result) {
                    results = result.data.data;
                  });
                case 6:
                  inputs = form.querySelectorAll(".fca");
                  for (i = 0; i < inputs.length; i++) {
                    theName = inputs[i].getAttribute('name');
  ...
  return {
    init: function init(elRoute, elModal, elModalContainer, elTriggers) {
      var elLoadData = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
      var elTitle = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'Editar';
      var elIdAttribute = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 'tt-id';
      var elEndHere = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : true;
...
window.datos = {
  ...
  removeNeed: function removeNeed(index) {
...
window.TTSelect = function (elSelectChange, elSelectUpdate, elRoute, elId, elVar) {
  var elStartValue = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
  var route = elRoute;
  var theId = elId;
  var firstLoad = true;
  var startValue = elStartValue;
  var theVar = elVar;
  var selectChange = elSelectChange;
  var selectUpdate = elSelectUpdate;
  ...
  var doActualization = function doActualization(elementSelect) {
    var id = elementSelect.value;
    if (id != undefined && id != '') {
      selectUpdate.innerHTML = "<option value=''>Cargando...</option>";
      var url = route.replace('content', id);
      axios.get(url).then(function (result) {
        var text = "<option value=''>Selecciona una opci\xF3n</option>";
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (firstLoad && startValue == val[theId]) {
              firstLoad = false;
              text += "<option selected value='".concat(val[theId], "'>").concat(val[theVar], "</option>");
            } else {
              text += "<option value='".concat(val[theId], "'>").concat(val[theVar], "</option>");
            }
          }
        } catch (err) {
          _iterator.e(err);
    ...
    submitButton.addEventListener('click', function (e) {
      ...
      validator.validate().then(function (status) {
        if (status == 'Valid') {
          ...
          axios.post(url, sendData).then(function (result) {
            var successMessage = result.data.message;
            if (!successMessage) {
              successMessage = 'No hay un mensaje del servidor';
            }
            ...
            Swal.fire({
              ...
              if (result.isConfirmed) {
                var redirectUrl = form.getAttribute('tt-redirect-url');
                if (redirectUrl) {
